    ...
    <>
      ...
      <section className="bg-[#1C3879] py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block bg-[#5A781E] bg-opacity-80 text-white text-sm font-semibold px-4 py-1.5 rounded-full mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
                ...
                {formState === "success" ? (
                  <div className="text-center py-12">
                    <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">
                      <svg className="w-8 h-8 text-[#5A781E]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className="text-[#5A781E] font-semibold hover:underline text-sm"
                    >
                      שלח הודעה נוספת
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <button
                      ...
                      className="w-full bg-[#5A781E] hover:bg-[#476016] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold px-6 py-4 rounded-xl transition-all duration-300 text-lg flex items-center justify-center gap-2"
                    >
            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-sm p-7">
                ...
                >
                  <div className="w-12 h-12 bg-[#5A781E] rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
              ...
              <div className="bg-[#1C3879] rounded-2xl p-7 text-white">
                <div className="w-12 h-12 bg-[#5A781E] rounded-xl flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <ul className="mt-4 space-y-2">
                  {[
                    ...
                    <li key={i} className="flex items-center gap-2 text-sm text-blue-100">
                      <svg className="w-4 h-4 text-[#5A781E] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
